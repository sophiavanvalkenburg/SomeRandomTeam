...
typedef enum {
    ...
    PROTO_MT_REQ_BASE_QUERY,
    /*
        PROTO_MT_REQ_BASE_NUM_JAIL,
        PROTO_MT_REQ_BASE_NUM_WALL,
        PROTO_MT_REQ_BASE_NUM_FLOOR,
        PROTO_MT_REQ_BASE_DIM,
        PROTO_MT_REQ_BASE_CINFO,
        PROTO_MT_REQ_BASE_DUMP,
     */
...
typedef enum {
    PROTO_STATE_INVALID_VERSION = 0, PROTO_STATE_INITIAL_VERSION = 1
} Proto_SVERS;
